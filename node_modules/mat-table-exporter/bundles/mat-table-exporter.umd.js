(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('cdk-table-exporter'),require('@angular/material/table'),exports, require('cdk-table-exporter'), require('@angular/material/table'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('mat-table-exporter', ['@angular/core','cdk-table-exporter','@angular/material/table','exports', 'cdk-table-exporter', '@angular/material/table', '@angular/core'], factory) :
    (global = global || self, factory(global.ng.core,global.cdkTableExporter,global.ng.material.table,global['mat-table-exporter'] = {}, global['cdk-table-exporter'], global.ng.material.table, global.ng.core));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, cdkTableExporter, table, core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MatTableExporterDirective = /** @class */ (function (_super) {
        ...
        MatTableExporterDirective = __decorate([ __param(3, core.Host()), __param(3, core.Self()), __param(3, core.Optional()),
            __metadata("design:paramtypes", [core.Renderer2,
                cdkTableExporter.ServiceLocatorService,
                cdkTableExporter.DataExtractorService,
                table.MatTable])
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MatTableExporterModule, { declarations: [MatTableExporterDirective], imports: [ɵngcc2.MatTableModule, ɵngcc1.CdkTableExporterModule], exports: [MatTableExporterDirective] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MatTableExporterModule, [{
    ...
    Object.keys(cdkTableExporter).forEach(function (k) {
        if (k !== 'default') Object.defineProperty(exports, k, {
            enumerable: true,
            get: function () {
                return cdkTableExporter[k];
            }
        });
    });
